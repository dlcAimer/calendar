...
public class DataTest {
    ...
    TodoList todoList, todoList1;
    Display display;
    CalendarDate calendarDate, calendarDate1;
    CalendarInterval calendarInterval, calendarInterval1, calendarInterval2, calendarInterval3, calendarInterval4, calendarInterval5;
    ...
    public void setUp() throws Exception {
        ...
        interval = new CalendarInterval (2018, 5, 1, 12, 0, 2018, 5, 1, 13, 0);
        interval1 = new CalendarInterval (2018, 5, 2, 12, 0, 2018, 5, 2, 12, 30);
        interval2 = new CalendarInterval (2018, 5, 2, 13, 0, 2018, 5, 3, 14, 0);
    ...
    public void testSaveAndLoad() throws Exception {
        CourseTodo courseTodo = new CourseTodo ("math", date, 12, 0, 13, 0, "", "", 10, "", "", 7, false, false);
        todoList = new TodoList ();
        todoList.add (courseTodo);
        Assert.assertEquals (10, todoList.getTodoList ().size ());
        display.setTodoArray (todoList);
        display.saveTodoList ();
        display.loadTodoList ();
        todoList1 = display.getTodoArray ();
        Assert.assertEquals (10, todoList1.getTodoList ().size ());
    }
